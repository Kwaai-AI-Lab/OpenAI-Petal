...
Write-Status "Running KwaaiNet Windows installer v0.2.23..."
...
if ($installationSuccessful -and $fixesApplied -ge 3) {
    ...
    Write-Host ""
    Write-TestSuccess "The KwaaiNet Windows installer v0.2.23 is PRODUCTION READY!"
    Write-Host ""
