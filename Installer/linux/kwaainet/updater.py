"""
Auto-update functionality for KwaaiNet on Linux
...
class Updater:
    ...
    def _update_git(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run(
                ...
                cwd=os.path.join(repo_path, 'Installer/linux'),
                capture_output=True,
                text=True
            )
    ...
    def _update_installer(self) -> bool:
        ...
        logger.info("  /bin/bash -c \"$(curl -fsSL https://raw.githubusercontent.com/Kwaai-AI-Lab/OpenAI-Petal/main/Installer/linux/linuxinstaller.sh)\"")
        ...
        try:
            ...
            result = subprocess.run(
                [sys.executable, '-m', 'pip', 'install', '--upgrade',
                 'git+https://github.com/Kwaai-AI-Lab/OpenAI-Petal.git#subdirectory=Installer/linux'],
                capture_output=True,
                text=True
            )
