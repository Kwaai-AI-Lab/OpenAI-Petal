...
class DaemonProcess:
    ...
    def _cleanup_related_processes(self):
        ...
        try:
            ...
            logger.warning(f"Error during related process cleanup: {e}")
    ...
    def start_process(self, command: list, env: dict = None, daemon_mode: bool = True, enable_monitoring: bool = True, concurrent: bool = False):
